...
import './city-bike-configuration.css';
...
const CityBikeConfiguration: React.FC<CityBikeConfigurationProps> = ({
  ...
  function onAddressSelect(address: Address) {
    setConfig((prev) => ({
      ...prev,
      homeCoordinates: address.coordinate,
      centerCoordinates: address.coordinate,
    }));
  }
